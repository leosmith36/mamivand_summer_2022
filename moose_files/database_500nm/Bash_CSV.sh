...
do
	...
	cp -R build include Makefile scripts test doc lib README.md idb4-opt LICENSE run_tests src ./run_m22_${m22[$i]}_m33_${m33[$i]}_m23_${m23[$i]}_k_${k[$i]}
