...
do
	...
	cp -R build include Makefile scripts test doc lib README.md whale2-opt LICENSE run_tests src ./run_m22_${m22[$i]}_m33_${m33[$i]}_m23_${m23[$i]}_k_${k[$i]}
    ...
    sed "s/FeCrCo.i/FeCrCo_m22_${m22[$i]}_m33_${m33[$i]}_m23_${m23[$i]}_k_${k[$i]}.i/g;s/SAMPLE_JOB/row_$i/g" <../slurm-batch.bash>slurm-batch.bash
